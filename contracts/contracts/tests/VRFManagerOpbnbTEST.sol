...
contract VRFv2SubscriptionManagerTEST is VRFConsumerBase, AccessControl {    
    ...
    function fulfillRandomWordsTest(uint256 _requestId, uint256[] memory _randomWords) external {
    ...
    // }
    function getCurRequestId() public view returns(uint256) {
        return curRequestId-1;
    }
}
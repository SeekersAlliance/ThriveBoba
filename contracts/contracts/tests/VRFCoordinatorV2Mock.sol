...
// /** 
//  * @notice 1. Deploy the VRFCoordinatorV2Mock. This contract is a mock of the VRFCoordinatorV2 contract.
//  * @notice 2. Call the VRFCoordinatorV2Mock createSubscription function to create a new subscription.
//  * @notice 3. Call the VRFCoordinatorV2Mock fundSubscription function to fund your newly created subscription. Note: You can fund with an arbitrary amount.
//  * @notice 4. Deploy your VRF consumer contract.
//  * @notice 5. Call the the VRFCoordinatorV2Mock addConsumer function to add your consumer contract to your subscription.
//  * @notice 6. Request random words from your consumer contract.
//  * @notice 7. Call the VRFCoordinatorV2Mock fulfillRandomWords function to fulfill your consumer contract request.
//  */
